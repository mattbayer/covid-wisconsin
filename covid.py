...
def read_pop_age_wi(dataset='census'):
    ...
    if dataset == 'census':
        ...
        pop_age.index.name = 'Age group'
        pop_age.name = 'Population'
        
    elif dataset == 'vax':
        pop_csv = '.\\data\\demographics\\Population-DHS-Vax-Age.csv'
        pop_age = pd.read_csv(pop_csv)
        pop_age = pop_age.set_index('Age group')
        pop_age = pop_age['Population']     # to convert to Series
...
def download_covid_data_wi(dataset='state'):
    ...
    urls = {'state' : "https://opendata.arcgis.com/datasets/859602b5d427456f821de3830f89301c_11.geojson",
            ...
            'state2' : "https://opendata.arcgis.com/datasets/531828fa923c490c8f1895db13d0040e_11.geojson",
            'county2': "https://opendata.arcgis.com/datasets/6496bdf64f7a44bba593862d04d01b2b_12.geojson",
            }
...
def scrape_widash_postest():
    ...
    pos_url = 'https://bi.wisconsin.gov/t/DHS/views/PercentPositivebyTestPersonandaComparisonandTestCapacity_16246449734350/PercentPositivebyTestDashboard?:embed_code_version=3&:embed=y&:loadOrderID=1&:display_spinner=no&:showAppBanner=false&:display_count=n&:showVizHome=n&:origin=viz_share_link'
