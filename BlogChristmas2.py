...
tests = covid.read_bytest_wi("data\\By_Test_Data_data_2021-01-22.csv")
...
wi = wi.loc[wi['Date'] <= datetime.datetime(2021,1,17)]
...
save_png = '.\\docs\\assets\\Christmas2-WI.png'
fig.write_image(
    save_png,
    width=700,
    height=340,
...
temp = temp.loc[temp['Date'] <= datetime.datetime(2021,1,17)]
...
pplot(fig, include_plotlyjs='cdn', filename=plotpath+'\\Christmas2-Milwaukee.html')

save_png = '.\\docs\\assets\\Christmas2-Milwaukee.png'
fig.write_image(
    save_png,
    width=700,
    height=500,
...
plotdata = monwed.iloc[-7:].reset_index(drop=True)
...
pplot(fig, include_plotlyjs='cdn', filename=plotpath+'\\Christmas2-MonWed-Milwaukee.html')

save_png = '.\\docs\\assets\\Christmas2-MonWed-Milwaukee.png'
fig.write_image(
    save_png,
    width=700,
    height=400,
